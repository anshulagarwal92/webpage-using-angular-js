...
carousal.prototype = {
    ...
    pageClickLinear :function(){
        var self = this;
        $(this.numberofpages+" a").unbind("click").bind("click", function() {
            if(self.myTimer) {
    ...
    bindEvents: function() {
        ...
        if(typeof this.isLinear === "undefined" && !this.isLinear ){
            $(self.nextButton+" img").unbind("click").bind("click", function() {
        ...
        if(typeof this.isLinear === "undefined" && !this.isLinear ){
            $(self.previousButton+" img").unbind("click").bind("click", function() {
                //when user clicks on button the autorotate function will not be working by clearing interval 
                //using clearInterval function
                if(self.myTimer) {
                    clearInterval(self.myTimer);
...
$(document).ready(function() {
    if(typeof window.mak !== "undefined" && window.mak) {
        delete window.mak;
    }
    window.mak = new carousal({
